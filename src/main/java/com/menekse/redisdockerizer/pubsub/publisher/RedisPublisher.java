package com.menekse.redisdockerizer.pubsub.publisher;
 ...
 * 2. **Simple message publishing**: This involves sending basic string messages to Redis channels.
 * <p>
...
public class RedisPublisher {
     ...
     * <p>
     * Why is this method needed?
     * - It allows the application to send basic text messages quickly to Redis channels.
